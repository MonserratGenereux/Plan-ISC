...
public class UseGraph {
	...
	public static void main(String[] args) {
		...
		WeightedGraphInterface<String> graphNum = new WeightedGraph<String>();
		...
		graphNum.addVertex(sa);
		graphNum.addVertex(sb);
		graphNum.addVertex(sc);
		graphNum.addVertex(sd);
		graphNum.addVertex(se);
		
		graphNum.addEdge(sa, sb, 3);
		graphNum.addEdge(sa, sc, 2);
		graphNum.addEdge(sb, se, 5);
		graphNum.addEdge(sc, sd, 2);
		graphNum.addEdge(sd, se, 1);
		
		shortestPaths(graphNum, "1");
		...
		System.out.println();
		System.out.println(); // shortestPaths(graph,s4);
		...
		graph.addEdge(s4, s2, 1000);
		graph.addEdge(s5, s0, 800);
		graph.addEdge(s6, s0, 600); //graph.addEdge(s6, s3, 1300);
		 ...
		 * 
		 * 
		 * System.out.println(); System.out.println(); shortestPaths(graph, s4);
		 */
